...
## Mettre à jours l'ordinateur

Saisir les commandes suivantes (apparemment "sudo" n'est pas nécessaire) :

```
apt update
apt upgrade -y
apt install -y vlc neofetch htop
apt clean
```

Installer ublock origin dans firefox
